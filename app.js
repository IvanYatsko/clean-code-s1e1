...
var addButton = document.querySelector(".section__block-button"); //first button
...
var createNewTaskElement = function(taskString) {
    ...
    editButton.className = "tasks__button button__edit";

    deleteButton.className = "tasks__button button__delete";
...
var editTask = function() {
    ...
    //If class of the parent is .tasks__item-edit
    if (containsClass) {

        //switch to .tasks__item-edit
    ...
    //toggle .tasks__item-edit on the parent.
